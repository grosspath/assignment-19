...
var githubApiKey = exports.githubApiKey = '574df63c557b12d2d8582d2f7002b5b01e76e5d2';
...
function controllerRouter() {
  ...
  var myPersonalInfo = _jquery2.default.getJSON('https://api.github.com/users/' + currentRoute + '?access_token=' + _secrets.githubApiKey).then(function (serverRes) {
    var myPersonalRepos = _jquery2.default.getJSON('https://api.github.com/users/' + currentRoute + '/repos?access_token=' + _secrets.githubApiKey).then(function (serverRes2) {

      var myPersonalInfo = document.querySelector('#app-container');
      ...
      var repoData = serverRes2.map(function (userObj) {

        var repoDataHtml = document.querySelector('.side-text');

        repoDataHtml.innerHTML += '\n    <div class="repo-data">\n      <a class="narrow" href="#">' + userObj.name + '</a>\n      <p class="narrow">' + userObj.description + '</p>\n      <p class="narrow">' + userObj.url + '</p>\n    </div>';
        var searchRepoEl = document.querySelector(".searchBarElement");
