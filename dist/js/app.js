...
var myPersonalInfo = _jquery2.default.getJSON('https://api.github.com/users/grosspath?access_token=' + _secrets.githubApiKey).then(function (serverRes) {

  var myPersonalRepos = _jquery2.default.getJSON('https://api.github.com/users/grosspath/repos?access_token=' + _secrets.githubApiKey).then(function (serverRes2) {
